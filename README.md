...
According to [Wikipedia](https://en.wikipedia.org/wiki/Fixed-point_iteration#Applications), the fixed point iteration to solve zeros of the derivative of the 1st order of Bessel function is:
...
According to [Wikipedia](https://en.wikipedia.org/wiki/Halley's_method#Method), the iteration of Halley's method to solve zeros of the derivative of the 1st order of Bessel function is:
